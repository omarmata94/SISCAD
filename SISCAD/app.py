...
def save_workbook(general, students_df, trimester_dfs, concentrado_df, resultados_df, output_path):
...
def main():
    ...
    if st.button("Guardar libro actualizado"):
        ...
        save_workbook(general, students, trimester_data, concentrado_df, resultados_df, output_path)
